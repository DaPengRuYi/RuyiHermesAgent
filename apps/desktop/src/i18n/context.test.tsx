...
describe('I18nProvider', () => {
  ...
  it('keeps the reusable provider default in English without an initial locale', () => {
    render(
  ...
  it('preserves the desktop Simplified Chinese initial locale for a fresh empty config', async () => {
  ...
  it('keeps the Simplified Chinese default when config loading fails', async () => {
    const configClient: I18nConfigClient = {
